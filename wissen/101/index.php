<?php
	...
	// ====================================================================================================================
	$template_intro_videorsc			= '../media/a.mp4';
	...
	$template_kurs1_info2 				= 'Kursstart: 13.01.2020, 3-mal<br/>Anmeldeschluss: 06.01.2020';
	...
	$template_kurs2_info2 				= 'Kurs-Nr.: S 134 005<br/>Kurspreis: CHF 459.00<br/>Anmeldeschluss: 17.10.2019';

	// ========================================================== VARIABLEN FÜR ABSPANN
	// ====================================================================================================================
	$template_abspann_claim				= 'Man kann nie wissen,<br />wann Wissen was nützt';
	$template_abspann_text 				= '100 Jahre Volkshochschule beider Basel. In dieser Zeit hat viel verändert. Vor allem die Geschwindigkeit, in der sich inzwischen alles verändert. Eines ist aber gleichgeblieben. Wir glauben an die Magie, die durch Wissen entsteht. Wir glauben, Wissen ist unsere beste Chance, um aus all den Veränderungen auch eine Verbesserung zu machen. Und dafür arbeiten wir mit der gleichen Leidenschaft, wie unsere Gründer vor 100 Jahren.';
